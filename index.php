...
<html lang="en">
  ...
  <body>
    ...
    <form id="refreshForm" style="display: inline;">
        <button type="button" class="btn btn-primary btn-round" onclick="window.location.href='fetch_emails.php'">Sync Emails</button>
    </form>
</div>
              </div>
            <div class="row">
    ...
    <tbody>
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            echo '<tr>';
            echo '<td><a href="view_email.php?id='.$row['id'].'" target="_blank">'.$row['subject'].'</a></td>';
